            ...
            if($view || is_siteadmin()){
                if($termsandconditions = $DB->get_record('block_termsandconditions',array("userid"=>$USER->id,"courseid"=>$COURSE->id)) || is_siteadmin()){
                    ...
                    $content .= "<script>
                        ...
                        "text += ".'"'."<li align = 'justify'> Los usuarios deberán abstenerse de publicar cualquier material bibliográfico que no sea de libre acceso, que no sea de dominio público o que no haya sido extraído desde el catálogo de obras disponibles en la Biblioteca de la Universidad Adolfo Ibáñez. En el caso de realizar una publicación de aquellas obras disponibles en el catálogo de la Biblioteca de la Universidad Adolfo Ibáñez, el material subido a la plataforma no podrá extenderse más allá del 15% del número total de sus páginas (Ejemplo: Si una obra tiene 100 páginas, deberán seleccionarse un máximo de 15 de ellas). O un capítulo completo del respectivo texto.</li>".'";'.
